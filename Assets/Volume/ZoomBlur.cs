...
public class ZoomBlur : VolumeComponent, IPostProcessComponent
{
    ...
    [Tooltip("模糊中心坐标已经在屏幕的中心（0,0）")] public Vector2Parameter focusScreenPosition = new Vector2Parameter(Vector2.zero);
    [Tooltip("参考宽度分辨率。")] public IntParameter referenceResolutionX = new IntParameter(1334);
